...
function writeBlogPosts() {
    ...
    xhrBlogPosts.open('GET', 'https://raw.githubusercontent.com/XeliteXirish/Logbot-v2/master/data/blog_posts.json');
...
function loadPosts() {
    ...
    for (var x = blogPosts.length; x > 0; x--) {
        ...
        subtitleArea.innerHTML = `By <strong>${author_username}</strong>, published: <i>${post_date}</i>`;
